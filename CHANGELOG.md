...
This release is a **major internal and UI upgrade** focused on making configuration easier, more reliable, and more future-proof—while also unlocking new features and improving the overall experience.

### 🚀 What’s New & Improved
- **New configuration interface** with seamless, automatic migration from the legacy config — no manual steps required
- **Brand-new form-based card editor**, offering clear, dedicated sections for each configuration area

![visual-editor](https://github.com/user-attachments/assets/ce330565-1763-49b6-ac05-6deaddbb35d5)

### Feaures
 **Full calendar view section**
 
![full-calendar](https://github.com/user-attachments/assets/71850a98-fe74-4448-87f0-cfaa6f386db4)

**Compact menu button option**
  
![compact-menu-button](https://github.com/user-attachments/assets/26b921f5-6f1c-4568-b130-a5dabce5c846)
...
**Full Changelog**: https://github.com/ngocjohn/lunar-phase-card/compare/v1.13.0...v1.14.0
