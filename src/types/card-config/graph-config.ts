...
export interface DefaultGraphConfig extends BaseGraphConfig {
  graph_type: 'default';
}

export interface DynamicGraphConfig extends BaseGraphConfig {
  graph_type: 'dynamic';
}

export type GraphConfig = DefaultGraphConfig | DynamicGraphConfig;
